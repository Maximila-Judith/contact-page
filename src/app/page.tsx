...
export default function Home() {
  ...
  return (
    <div className="flex flex-col lg:items-center gap-y-10 lg:p-20">
      ...
      <form className="lg:w-3/4 flex flex-col gap-10 bg-[#CDD5E066] rounded-3xl m-10 p-10">
        ...
        <button type="button" className="w-full py-5 px-4 inline-flex justify-center items-center gap-x-2 text-xl font-bold rounded-2xl dark:bg-white hover:dark:bg-[#4036A9] hover:dark:text-white dark:text-[#4036A9]">
          Contact Sales
        </button>
      </form>
    </div>
